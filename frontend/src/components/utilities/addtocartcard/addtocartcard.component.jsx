      ...
      <table className='cartform u-margin-top-medium'>
        ...
        <tr>
          ...
          <span className='paragraph u-center-text'>
            ${product.variants[checkedBoxIndex].price} ea x {qty} = $
            {(product.variants[checkedBoxIndex].price * qty).toFixed(2)}
          </span>
        </tr>
        <tr>
          <button
            ...
            onClick={() =>
              addToCartHandler(product.variants[checkedBoxIndex]._id)
            }
