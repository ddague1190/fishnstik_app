  ...
  return (
    <div className='waves'>
      ...
      {/* <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320'>
        <path
        className='waves__wave'
          d='M0,64L20,80C40,96,80,128,120,138.7C160,149,200,139,240,165.3C280,192,320,256,360,282.7C400,309,440,299,480,293.3C520,288,560,288,600,256C640,224,680,160,720,149.3C760,139,800,181,840,197.3C880,213,920,203,960,213.3C1000,224,1040,256,1080,245.3C1120,235,1160,181,1200,149.3C1240,117,1280,107,1320,112C1360,117,1400,139,1420,149.3L1440,160L1440,320L1420,320C1400,320,1360,320,1320,320C1280,320,1240,320,1200,320C1160,320,1120,320,1080,320C1040,320,1000,320,960,320C920,320,880,320,840,320C800,320,760,320,720,320C680,320,640,320,600,320C560,320,520,320,480,320C440,320,400,320,360,320C320,320,280,320,240,320C200,320,160,320,120,320C80,320,40,320,20,320L0,320Z'></path>
      </svg> */}
    </div>
  );
};
